...
document.addEventListener("DOMContentLoaded", function(){
    ...
    const swiperList = document.querySelector(".swiperList__europe");
...
document.addEventListener("DOMContentLoaded", function(){
    ...
    const swiperList = document.querySelector(".swiperList__health");
...
document.addEventListener("DOMContentLoaded", function(){
    ...
    const swiperList = document.querySelector(".swiperList__sports");
...
document.addEventListener("DOMContentLoaded", function(){
    ...
    const swiperList = document.querySelector(".swiperList__travel");
